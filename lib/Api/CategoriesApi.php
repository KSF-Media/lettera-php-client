...
class CategoriesApi
{
     ...
     */
    public function categoriesGet($paper = null)
    {
        list($response) = $this->categoriesGetWithHttpInfo($paper);
        return $response;
    }
     ...
     */
    public function categoriesGetWithHttpInfo($paper = null)
    {
        $request = $this->categoriesGetRequest($paper);
     ...
     */
    public function categoriesGetAsync($paper = null)
    {
        return $this->categoriesGetAsyncWithHttpInfo($paper)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function categoriesGetAsyncWithHttpInfo($paper = null)
    {
        $returnType = '\OpenAPI\Client\Model\Category[]';
        $request = $this->categoriesGetRequest($paper);
     ...
     */
    protected function categoriesGetRequest($paper = null)
    {
